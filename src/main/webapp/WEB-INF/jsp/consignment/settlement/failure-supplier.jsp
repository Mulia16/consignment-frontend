...
<head>
    ...
    <title>Failed Supplier Consignment Compute</title>
    <!-- CSS -->
...
<body>
    ...
    <div class="main-content">
        <jsp:include page="/WEB-INF/jsp/common/header.jsp">
            <jsp:param name="pageTitle" value="Failed Supplier Consignment Compute" />
        </jsp:include>
        ...
        <div class="container-fluid mt-3">
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb bg-transparent p-0 m-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Failed Supplier Consignment Compute</li>
                </ol>
            </nav>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <input type="text" class="form-control form-control-sm" placeholder="Supplier Name/Code">
                        </div>
                        ...
                        <table class="table table-hover table-bordered table-sm align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>2023-08-31 09:05</td>
                                    <td>Alpro Pharmacy SDN BHD</td>
                                    <td>1001</td>
                                    <td>0000040174 - DKSH (M) SDN BHD</td>
                                    <td>2023-08-01 to 2023-08-31</td>
                                    <td><span class="text-danger">Invalid item stock quantity calculation</span></td>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            $('#nav-consignment-failure-supplier').addClass('active');
        ...
        function actionPrint() {
           alert('Printing failed supplier compute report...');
        }
